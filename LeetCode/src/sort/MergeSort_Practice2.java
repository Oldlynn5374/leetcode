...
public class MergeSort_Practice2 {
    ...
    public static void main(String[] args) {
        ...
        MergeSort_Practice2 mergeSort_practice2 = new MergeSort_Practice2();
        mergeSort_practice2.sort(a,0,a.length-1,new int[a.length]);
        for (int i : a){
            System.out.print(i + " ");
        }
    }
